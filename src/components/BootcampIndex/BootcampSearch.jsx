...
return (
    <form className="flex flex-col items-center" onSubmit={handleSubmit}>
        ...
        <div className="flex gap-3 justify-center mb-10">
            ...
            <p className="bg-gray-500 p-3 rounded-full">Number of results: {displayedBootcamps.length}</p>
            <button className="bg-gray-500 p-3 rounded-full" onClick={reset}>Show all bootcamps</button>
        </div>
    </form>
)
}
